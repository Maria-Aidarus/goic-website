...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'GOIC_Final_Website_fd4a3dfaa0c8ab728122_20240421175654_archive.zip';
        const ARCHIVE_SIZE       = '917004304';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'fd4a3df-21175654';
        const SECONDARY_PACKAGE_HASH = 'd2ebd5c-21175654';
        const VERSION            = '1.5.9';
