...
class adminObserver{
    ...
    private function mo_sps_automatic_connection() {
        ...
        $config['connector'] = wpWrapper::mo_sps_get_option(pluginConstants::CLOUD_CONNECTOR);
    ...
    private function mo_sps_show_success_message_for_test_connection($response){
        ...
        update_option("test_connection_status","success");
        update_option("test_connection_user_details",$response);
        $connector = wpWrapper::mo_sps_get_option(pluginConstants::CLOUD_CONNECTOR);
    ...
    private function mo_sps_display_test_attributes($upn=NULL){
        update_option("test_connection_manual_status","success")
        ?>
        ...
        <script>
            ...
            function close_and_redirect_to_shortcode_tab(){
                window.opener.redirect_to_shortcode_tab();
                 self.close();
            }
